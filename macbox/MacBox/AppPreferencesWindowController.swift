...
public class AppPreferencesWindowController: NSWindowController {
    ...
    @objc
    static let sharedInstance : AppPreferencesWindowController = AppPreferencesWindowController.instantiateFromStoryboard()
    ...
    public func show( tab : AppPreferencesTab = .general ) {
        let vc = self.contentViewController as! NSTabViewController
