...
class BrowseTabViewController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(forName: Notification.Name(rawValue: kTabsMayHaveChangedDueToModelEdit), object: nil, queue: nil) { [weak self] notification in
